...
def create_app(config_class=Config):
    ...
    from api.routes.subaccounts import subaccounts_bp
    from api.routes.account_movements import account_movements_bp
    ...
    app.register_blueprint(account_movements_bp)
